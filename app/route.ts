  ...
  const footer = `<footer class="cloudy-shared-footer">
    <div class="cloudy-shared-footer-inner">
      <div class="cloudy-shared-footer-grid">
        ...
        <div><div class="cloudy-shared-footer-title">Community</div><div class="cloudy-shared-footer-links"><a href="${DISCORD_URL}" target="_blank" rel="noopener noreferrer">Discord</a><a href="/appeal">Appeal form</a></div></div>
        <div><div class="cloudy-shared-footer-title">Information</div><div class="cloudy-shared-footer-links"><a href="/legal#terms">Terms of service</a><a href="/legal#sales">Terms of sale</a></div></div>
      </div>
...
.product-art:after{content:"";position:absolute;inset:-40% auto -40% -65%;width:42%;pointer-events:none;background:linear-gradient(105deg,transparent,rgba(255,255,255,.13),transparent);transform:skewX(-16deg)}
...
@keyframes cloudy-game-sheen{from{left:-65%}to{left:130%}}
@media(hover:hover){
...
.product-card:hover .product-art:after{animation:cloudy-game-sheen .72s cubic-bezier(.2,.7,.2,1) forwards}
...
.product-art:after{display:none!important}
